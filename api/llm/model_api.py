...
from schemas.llm import ModelConfigResponse, ModelConfigCreate, ModelConfigUpdate
from services.llm.model_service import ModelService


@model_router.get("/page_list", response_model=PageResponse[ModelConfigResponse],
                  description="分页获取模型")
async def page_list_model(
        ...
        model_type: Optional[ModelType | str] = Query(None, description="模型类型"),
...
@model_router.get("/list", response_model=Result[List[ModelConfigResponse]],
                  description="分页获取模型")
...
@model_router.post("/create", response_model=Result[ModelConfigResponse], description="创建模型")
...
@model_router.put("/update", response_model=Result[ModelConfigResponse], description="更新模型")
